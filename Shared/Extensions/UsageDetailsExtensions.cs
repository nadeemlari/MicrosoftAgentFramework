...
public static class UsageDetailsExtensions
{
    ...
    public static void OutputAsInformation(this UsageDetails? usageDetails)
    {
        ...
        DisplayUtil.WriteLineInformation($"- Input Tokens: {usageDetails.InputTokenCount}");
        DisplayUtil.WriteLineInformation($"- Output Tokens: {usageDetails.OutputTokenCount} " +
