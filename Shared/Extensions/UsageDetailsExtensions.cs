...
//         ConsoleUtils.WriteLineInformation($"- Input Tokens: {usageDetails.InputTokenCount}");
//         ConsoleUtils.WriteLineInformation($"- Output Tokens: {usageDetails.OutputTokenCount} " +
