...
var embeddingClient = OpenAIClientProvider.GetOpenAIClient(OpenAI_LLM_Providers.OpenAI).GetEmbeddingClient("text-embedding-3-small");
var pdfIngestor = new PdfIngestor(chunksCollection, documentsCollection);
await pdfIngestor.IngestDataAsync(new PdfDirectorySource(@"C:\Users\mnadeem\RiderProjects\MicrosoftAgentFramework\WebCrawler\Data\Pdfs", embeddingClient));
#endregion
