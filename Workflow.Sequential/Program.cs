...
var client = AIChatClientProvider.GetOpenAI(OpenAI_LLM_Providers.OpenRouter, model);
...
var result = await workflowAgent.RunAsync(legalText);
DisplayUtil.StopLoading();
DisplayUtil.Separator();
DisplayUtil.WriteLineInformation("Final Result:");
DisplayUtil.WriteLineYellow(result.Text);
